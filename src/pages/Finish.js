...
const Finish = () => {
  ...
  return (
    <Wrapper>
      <FinishBanner showStatistics={showStatistics} onShowStatistics={onShowStatistics} time={moment.unix(results.timeInSec).format("mm:ss")} correct={results.correctAnswers} all={results.totalQuizzes}/>
